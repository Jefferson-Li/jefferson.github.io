(function () {
  ...
  var dict = {
    zh: {
      ...
      "about.p2":
        "近期作品包含本機文件轉換服務 Doc2Any，以及用 React Native、Flutter、Python 實作的繪圖系列。",
      "about.focus": "Focus",
    ...
    en: {
      ...
      "about.p2":
        "Recent work includes Doc2Any, a local document converter, plus drawing apps built with React Native, Flutter, and Python.",
      "about.focus": "Focus",
      "about.contact": "Contact",
      "skills.label": "Skills",
